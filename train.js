...
// console.log(checkContent("Sardor", "Rasdor")) // true
...
class Shop {
  ...
  qoldiq() {
    console.log(`Hozir ${this.logTime()}da ${this.products.non}ta non, ${this.products.lagmon}ta lagmon va ${this.products.cola}ta cola mavjud!`);
  }
